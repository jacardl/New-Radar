...
class XhsStoreFactory:
    ...
    def create_store() -> AbstractStore:
        ...
        if not store_class:
            raise ValueError("[XhsStoreFactory.create_store] Invalid save option: only 'postgres' is supported.")
        return store_class()
...
async def update_xhs_note(note_item: Dict):
    ...
    await store_crawled_data(local_db_item, "xhs", "content")
...
async def update_xhs_note_comment(note_id: str, comment_item: Dict):
    ...
    await store_crawled_data(local_db_item, "xhs", "comment")
