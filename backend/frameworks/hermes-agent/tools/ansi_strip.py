...
from entering the model's context â€?which is the root cause of models
...
# Fast-path check â€?skip full regex when no escape-like bytes are present.
...
def strip_ansi(text: str) -> str:
    ...
    present.  Safe to call on any string â€?clean text passes through
