...
def resolve_secret_input(value: Any, env: Optional[Dict[str, str]] = None) -> Optional[str]:
    ...
    if isinstance(value, dict):
        ...
        # File/exec sources can't be resolved here ÃÂ¢?return None
    return None
...
class Migrator:
    ...
    def migrate_messaging_settings(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        if isinstance(workspace, str) and workspace.strip():
            ...
            # Skip if the workspace points inside the OpenClaw source directory ÃÂ¢?
    ...
    def migrate_provider_keys(self, config: Dict[str, Any]) -> None:
        ...
        # Also check the OpenClaw .env file ÃÂ¢?many users store keys there
        ...
        # Check the openclaw.json "env" sub-object ÃÂ¢?some OpenClaw setups
    ...
    def generate_migration_notes(self) -> None:
        ...
        notes.extend([
            ...
            "The directory is renamed, not deleted ÃÂ¢?you can undo this at any time.",
            "",
...
def main() -> int:
    ...
    print()
    print(f"  ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢")
    print(f"  ÃÂ¢?  OpenClaw -> Hermes Migration   [{mode_label:>8s}]   ÃÂ¢?)
    print(f"  ÃÂ¢ÃÂ ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ£")
    print(f"  ÃÂ¢? Source:  {str(report['source_root'])[:42]:<42s}  ÃÂ¢?)
    print(f"  ÃÂ¢? Target:  {str(report['target_root'])[:42]:<42s}  ÃÂ¢?)
    print(f"  ÃÂ¢ÃÂ ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ£")
    print(f"  ÃÂ¢? ÃÂ¢?Migrated:  {s.get('migrated', 0):>3d}    ÃÂ¢?Archived:  {s.get('archived', 0):>3d}        ÃÂ¢?)
    print(f"  ÃÂ¢? ÃÂ¢?Skipped:   {s.get('skipped', 0):>3d}    ÃÂ¢?Conflicts: {s.get('conflict', 0):>3d}        ÃÂ¢?)
    print(f"  ÃÂ¢? ÃÂ¢?Errors:    {s.get('error', 0):>3d}    Total:       {total:>3d}        ÃÂ¢?)
    print(f"  ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢")
    ...
    if archived:
        ...
        for item in archived:
            ...
            print(f"    ÃÂ¢?{display:<35s}  {short_reason}")
    ...
    if conflicts:
        ...
        for item in conflicts:
            print(f"    ÃÂ¢?{item['kind']}: {item.get('reason', '')}")
    ...
    # PM2 reassurance
    print()
    print("  ÃÂ¢?PM2 processes (Discord/Telegram bots) are NOT affected.")
    ...
    if args.execute:
        ...
        if report.get("output_dir"):
            print(f"    ÃÂ¢?Full report: {report['output_dir']}/MIGRATION_NOTES.md")
