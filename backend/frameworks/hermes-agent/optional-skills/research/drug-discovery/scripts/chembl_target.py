#!/usr/bin/env python3
"""
chembl_target.py â€?Search ChEMBL for a target and retrieve top active compounds.
...
def main():
    parser = argparse.ArgumentParser(description="ChEMBL target â†?active compounds")
    ...
    print(f"\nFetching compounds with pChEMBL â‰?{args.min_pchembl}...\n")
