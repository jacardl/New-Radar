...
def log_success(msg: str):
    print(f"{color('â?, Colors.GREEN)} {msg}")

def log_warn(msg: str):
    print(f"{color('â?, Colors.YELLOW)} {msg}")
...
def run_uninstall(args):
    ...
    print()
    print(color("+---------------------------------------------------------â?, Colors.MAGENTA, Colors.BOLD))
    print(color("â?           â?Hermes Agent Uninstaller                  â?, Colors.MAGENTA, Colors.BOLD))
    print(color("â---------------------------------------------------------â?, Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    print()
    if full_uninstall:
        print(color("â ï¸  WARNING: This will permanently delete ALL Hermes data!", Colors.RED, Colors.BOLD))
    ...
    # Done
    print()
    print(color("+---------------------------------------------------------â?, Colors.GREEN, Colors.BOLD))
    print(color("â?             â?Uninstall Complete!                      â?, Colors.GREEN, Colors.BOLD))
    print(color("â---------------------------------------------------------â?, Colors.GREEN, Colors.BOLD))
    print()
    ...
    print()
    print("Thank you for using Hermes Agent! â?)
    print()
