    ...
    if explicit_provider:
        ...
        if pdef is None:
            ...
            try:
                ...
                if _cfg_issues:
                    _switch_err += "\n\nRun 'hermes doctor' â€?config issues detected:"
...
def list_authenticated_providers(
    ...
    # Build reverse mapping: models.dev ID â†?Hermes provider ID.
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        # Resolve Hermes slug â€?e.g. "github-copilot" â†?"copilot"
        ...
        # Use curated list â€?look up by Hermes slug, fall back to overlay key
