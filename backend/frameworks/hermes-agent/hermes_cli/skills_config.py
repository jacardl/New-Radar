...
def skills_command(args=None):
    ...
    if mode == "2":
        ...
        # "selected" = enabled (not disabled) â?matches the [â] convention
    ...
    print(color(f"â?Saved: {enabled_count} enabled, {len(new_disabled)} disabled ({platform_label}).", Colors.GREEN))
