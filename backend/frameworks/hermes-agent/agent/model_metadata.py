...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    "qwen": 131072,
    # MiniMax â€?official docs: 204,800 context for all models
...
def _resolve_nous_context_length(model: str) -> Optional[int]:
    ...
    with version normalization (dotâ†”dash).
    """
    ...
    # Partial prefix match for cases like gemini-3-flash â†?gemini-3-flash-preview
