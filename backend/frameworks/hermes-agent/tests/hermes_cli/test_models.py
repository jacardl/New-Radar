...
class TestFilterNousFreeModels:
    """Tests for filter_nous_free_models â€?Nous Portal free-model policy."""
    ...
    def test_mixed_scenario(self):
        ...
        models = [
            "anthropic/claude-opus-4.6",       # paid, not allowlist â†?keep
            "nvidia/nemotron-3-super-120b-a12b:free",  # free, not allowlist â†?drop
            "xiaomi/mimo-v2-pro",              # free, allowlist â†?keep
            "xiaomi/mimo-v2-omni",             # paid, allowlist â†?drop
            "openai/gpt-5.4",                  # paid, not allowlist â†?keep
        ]
        pricing = {
            "anthropic/claude-opus-4.6": self._PAID,
