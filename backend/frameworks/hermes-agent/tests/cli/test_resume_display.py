"""Tests for session resume history display ÃÂ¢?_display_resumed_history() and
...
def _simple_history():
    """Two-turn conversation: user ÃÂ¢?assistant ÃÂ¢?user ÃÂ¢?assistant."""
    return [
...
class TestDisplayResumedHistory:
    ...
    def test_long_user_message_truncated(self):
        ...
        assert 200 <= a_count <= 310  # roughly 300 chars (ÃÃÂ±panel padding)
