...
class TestRedirectStdoutIsProcessWide(unittest.TestCase):
    ...
    def test_redirect_stdout_affects_other_threads(self):
        ...
        def other_thread_work():
            ...
            # Try to print â€?this should go to devnull
        ...
        self.assertTrue(
            ...
            "redirect_stdout was NOT process-wide â€?other thread still saw real stdout. "
            "This test's premise is wrong."
        )
        print("Confirmed: redirect_stdout IS process-wide â€?affects all threads")
