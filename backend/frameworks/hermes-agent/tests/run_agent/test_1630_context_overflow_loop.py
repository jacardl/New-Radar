"""Tests for #1630 â€?gateway infinite 400 failure loop prevention.
...
# ---------------------------------------------------------------------------
# Test 1: Agent heuristic â€?generic 400 with large session â†?compression
# ---------------------------------------------------------------------------
...
class TestGeneric400Heuristic:
    ...
    def test_generic_400_with_small_session_is_client_error(self):
        ...
        assert not is_large_session  # Small session â†?heuristic doesn't fire
    ...
    def test_generic_400_with_large_token_count_triggers_heuristic(self):
        ...
        # Both conditions true â†?should be treated as context overflow
    ...
    def test_specific_error_message_bypasses_heuristic(self):
        ...
        is_generic_error = len(error_msg.strip()) < 30
        assert not is_generic_error  # Long specific message â†?heuristic doesn't fire
