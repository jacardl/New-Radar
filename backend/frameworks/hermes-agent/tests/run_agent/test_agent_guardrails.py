...
Covers three static methods on AIAgent (inspired by PR #1321 â€?@alireza78a):
  - _sanitize_api_messages()    â€?Phase 1: orphaned tool pair repair
  - _cap_delegate_task_calls()  â€?Phase 2a: subagent concurrency limit
  - _deduplicate_tool_calls()   â€?Phase 2b: identical call deduplication
"""
...
# ---------------------------------------------------------------------------
# Phase 1 â€?_sanitize_api_messages
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Phase 2a â€?_cap_delegate_task_calls
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Phase 2b â€?_deduplicate_tool_calls
# ---------------------------------------------------------------------------
