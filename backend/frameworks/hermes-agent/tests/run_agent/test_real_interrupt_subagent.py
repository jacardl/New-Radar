...
interrupt flow through _run_single_child â†?child.run_conversation().
"""
...
class TestRealSubagentInterrupt(unittest.TestCase):
    ...
    def test_interrupt_child_during_api_call(self):
        ...
        def run_delegate():
            try:
                ...
                with patch('run_agent.OpenAI') as MockOpenAI:
                    ...
                    # API call takes 5 seconds â€?should be interrupted before that
        ...
        self.assertLess(elapsed, 3.0,
                       f"Took {elapsed:.2f}s â€?interrupt was not detected quickly enough")
