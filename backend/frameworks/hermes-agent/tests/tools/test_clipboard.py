"""Tests for clipboard image paste ÃÂ¢?clipboard extraction, multimodal conversion,
and CLI integration.

Coverage:
  hermes_cli/clipboard.py  ÃÂ¢?platform-specific image extraction (macOS, WSL, Wayland, X11)
  cli.py                   ÃÂ¢?_try_attach_clipboard_image, _build_multimodal_content,
...
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
# Level 1: Clipboard module ÃÂ¢?platform dispatch + tool interactions
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
...
class TestMacosHasImage:
    def test_png_detected(self):
        with patch("hermes_cli.clipboard.subprocess.run") as mock_run:
            mock_run.return_value = MagicMock(
                stdout="ÃÃÂ«class PNGfÃÃÂ», ÃÃÂ«class ut16ÃÃÂ»", returncode=0
            )
    ...
    def test_tiff_detected(self):
        with patch("hermes_cli.clipboard.subprocess.run") as mock_run:
            mock_run.return_value = MagicMock(
                stdout="ÃÃÂ«class TIFFÃÃÂ»", returncode=0
            )
            assert _macos_has_image() is True
    ...
    def test_text_only(self):
        with patch("hermes_cli.clipboard.subprocess.run") as mock_run:
            mock_run.return_value = MagicMock(
                stdout="ÃÃÂ«class ut16ÃÃÂ», ÃÃÂ«class utf8ÃÃÂ»", returncode=0
            )
...
class TestMacosOsascript:
    ...
    def test_success_with_png(self, tmp_path):
        ...
        def fake_run(cmd, **kw):
            calls.append(cmd)
            if len(calls) == 1:
                return MagicMock(stdout="ÃÃÂ«class PNGfÃÃÂ», ÃÃÂ«class ut16ÃÃÂ»", returncode=0)
            dest.write_bytes(FAKE_PNG)
    ...
    def test_success_with_tiff(self, tmp_path):
        ...
        def fake_run(cmd, **kw):
            calls.append(cmd)
            if len(calls) == 1:
                return MagicMock(stdout="ÃÃÂ«class TIFFÃÃÂ»", returncode=0)
            dest.write_bytes(FAKE_PNG)
            return MagicMock(stdout="", returncode=0)
        with patch("hermes_cli.clipboard.subprocess.run", side_effect=fake_run):
            assert _macos_osascript(dest) is True
    ...
    def test_extraction_returns_fail(self, tmp_path):
        ...
        def fake_run(cmd, **kw):
            calls.append(cmd)
            if len(calls) == 1:
                return MagicMock(stdout="ÃÃÂ«class PNGfÃÃÂ»", returncode=0)
...
class TestIsWsl:
    def setup_method(self):
        # _is_wsl is now hermes_constants.is_wsl ÃÂ¢?reset its cache
...
class TestWaylandSave:
    def test_png_extraction(self, tmp_path):
        ...
        def fake_run(cmd, **kw):
            ...
            # Extract call ÃÂ¢?write fake data to stdout file
...
class TestLinuxSave:
    """Test that _linux_save dispatches correctly to WSL ÃÂ¢?Wayland ÃÂ¢?X11."""
    ...
    def test_file_still_usable_when_no_converter(self, tmp_path):
        ...
        with patch.dict(sys.modules, {"PIL": None, "PIL.Image": None}):
            with patch("hermes_cli.clipboard.subprocess.run", side_effect=FileNotFoundError):
                ...
                # Raw BMP is better than nothing ÃÂ¢?function should return True
...
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
# Level 2: _preprocess_images_with_vision ÃÂ¢?image ÃÂ¢?text via vision tool
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
...
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
# Level 3: _try_attach_clipboard_image ÃÂ¢?state management
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?

class TestTryAttachClipboardImage:
    """Test the clipboard ÃÂ¢?state flow."""
...
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
# Level 4: Queue routing ÃÂ¢?tuple unpacking in process_loop
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
...
class TestQueueRouting:
    ...
    def test_empty_text_with_images(self, tmp_path):
        """Images without text ÃÂ¢?text should be empty string."""
        img = tmp_path / "test.png"
        img.write_bytes(FAKE_PNG)
        user_input = ("", [img])
