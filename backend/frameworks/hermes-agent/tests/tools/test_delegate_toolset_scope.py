...
The LLM controls the `toolsets` parameter â€?without intersection with the
...
class TestToolsetIntersection:
    ...
    def test_requested_toolsets_intersected_with_parent(self):
        """LLM requests toolsets parent doesn't have â€?extras are dropped."""
    ...
    def test_all_requested_toolsets_available_on_parent(self):
        """LLM requests subset of parent tools â€?all pass through."""
