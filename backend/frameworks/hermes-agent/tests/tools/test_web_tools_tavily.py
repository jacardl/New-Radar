...
Coverage:
  _tavily_request() â?API key handling, endpoint construction, error propagation.
  _normalize_tavily_search_results() â?search response normalization.
  _normalize_tavily_documents() â?extract/crawl response normalization, failed_results.
  web_search_tool / web_extract_tool / web_crawl_tool â?Tavily dispatch paths.
"""
...
class TestTavilyRequest:
    ...
    def test_raises_without_api_key(self):
        """No TAVILY_API_KEY â?ValueError with guidance."""
