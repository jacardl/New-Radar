"""Tests for tools/checkpoint_manager.py â€?CheckpointManager."""
...
def checkpoint_base(tmp_path):
    """Isolated checkpoint base â€?never writes to ~/.hermes/."""
...
class TestTakeCheckpoint:
    ...
    def test_no_changes_skips_commit(self, mgr, work_dir):
        ...
        # No file changes â€?should return False (nothing to commit)
...
# =========================================================================
# CheckpointManager â€?listing checkpoints
# =========================================================================
...
class TestErrorResilience:
    ...
    def test_checkpoint_failure_does_not_raise(self, mgr, work_dir, monkeypatch):
        """Checkpoint failures should never raise â€?they're silently logged."""
