...
class TestIsLikelyBinary:
    ...
    def test_binary_content_returns_true(self, ops):
        ...
        # 500 NUL bytes + 500 printable = 50% non-printable â†?binary
    ...
    def test_no_content_sample_returns_false(self, ops):
        """When no content sample is provided and extension is unknown â†?not binary."""
    ...
    def test_empty_string_content_sample_returns_false(self, ops):
        """Empty string is falsy, so content analysis should be skipped â†?not binary."""
    ...
    def test_threshold_boundary(self, ops):
        ...
        # 300 NUL bytes + 700 printable = 30.0% â†?should be False (uses strict >)
    ...
    def test_just_above_threshold(self, ops):
        """301/1000 = 30.1% non-printable â†?should be binary."""
    ...
    def test_content_sample_longer_than_1000(self, ops):
        ...
        # First 1000 chars: 200 NUL + 800 printable = 20% â†?not binary
        # Remaining 1000 chars: all NUL â†?ignored by [:1000] slice
