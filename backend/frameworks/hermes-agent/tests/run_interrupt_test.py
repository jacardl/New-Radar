...
Not a pytest test é¥?runs directly as a script for live testing.
"""
...
def main() -> int:
    ...
    if result:
        ...
        if elapsed < 2.0:
            print("é?PASS: Interrupt detected quickly!")
        else:
            print(f"é?FAIL: Took {elapsed:.2f}s é¥?interrupt was too slow or not detected")
    else:
        print("é?FAIL: No result!")
