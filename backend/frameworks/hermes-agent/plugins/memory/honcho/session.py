...
class HonchoSessionManager:
    ...
    def __init__(
        ...
        # Prefetch caches: session_key â†?last result (consumed once per turn)
    ...
    def dialectic_query(
        ...
        representation. Higher latency than context() â€?call async via
        ...
        try:
            if self._ai_observe_others:
                # AI peer can observe user â€?use cross-observation routing
                if peer == "ai":
                ...
                # AI can't observe others â€?each peer queries self
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        is intentionally omitted â€?it would only affect additional excerpts
    ...
    def get_peer_card(self, session_key: str) -> list[str]:
        """
        Fetch the user peer's card â€?a curated list of key facts.
    ...
    def create_conclusion(self, session_key: str, content: str) -> bool:
        ...
        Conclusions are facts the AI peer observes about the user â€?
        ...
        try:
            if self._ai_observe_others:
                ...
                # AI can't observe others â€?user peer creates self-conclusion
                user_peer = self._get_or_create_peer(session.user_peer_id)
