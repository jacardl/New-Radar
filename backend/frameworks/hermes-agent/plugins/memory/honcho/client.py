...
def resolve_config_path() -> Path:
    ...
    Resolution order:
      ...
      2. ~/.hermes/honcho.json          (default profile â€?shared host blocks live here)
...
class HonchoClientConfig:
    ...
    #   true  â€?low->medium (120+ chars), low->high (400+ chars), capped at "high"
    #   false â€?always use dialecticReasoningLevel as-is
    ...
    # Does NOT enable automatic context injection â€?only changes init timing.
    ...
    def resolve_session_name(
        ...
        Resolution order:
          ...
          3. per-session strategy â€?Hermes session_id ({timestamp}_{hex})
          4. per-repo strategy â€?git repo root directory name
          5. per-directory strategy â€?directory basename
          6. global strategy â€?workspace name
        """
        import re
