...
PROFILE_SCHEMA = {
    "name": "honcho_profile",
    "description": (
        "Retrieve the user's peer card from Honcho â€?a curated list of key facts "
...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        try:
            ...
            # Only when no explicit peerName was configured â€?an explicit peerName
            ...
            # ----- Port #1969: aiPeer sync from SOUL.md â€?REMOVED -----
            ...
            if self._recall_mode == "tools":
                if cfg.init_on_session_start:
                    ...
                    # Does NOT enable auto-injection â€?prefetch() still returns empty.
                    logger.debug("Honcho tools-only mode â€?eager session init (initOnSessionStart=true)")
    ...
    def queue_prefetch(self, query: str, *, session_id: str = "") -> None:
        ...
        # B5: cadence check â€?skip if too soon since last dialectic call
