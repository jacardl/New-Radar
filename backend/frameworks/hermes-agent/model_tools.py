...
def _discover_tools():
    ...
    _modules = [
        ...
        # "tools.honcho_tools",  # Removed â€?Honcho is now a memory provider plugin
...
def handle_function_call(
    ...
    """
    # Coerce string arguments to their schema-declared types (e.g. "42"â†?2)
    ...
    try:
        ...
        if not skip_pre_tool_call_hook:
            ...
            # Still fire the hook for observers â€?just don't check for blocking
