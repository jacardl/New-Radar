#!/usr/bin/env python3
"""
Parseltongue v4 ÃÂ¢?Input Obfuscation Engine
...
# ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢?
...
UNICODE_MAP = {'a': 'ÃÃÂ°', 'c': 'Ã', 'e': 'ÃÃÂµ', 'i': 'Ã', 'o': 'ÃÃÂ¾',
               'p': 'Ã', 's': 'Ã', 'x': 'Ã', 'y': 'Ã'}
...
SUPERSCRIPT_MAP = {
    'a': 'ÃÂ¡ÃÂµ?, 'b': 'ÃÂ¡ÃÂµ?, 'c': 'ÃÂ¡ÃÂ¶?, 'd': 'ÃÂ¡ÃÂµ?, 'e': 'ÃÂ¡ÃÂµ?, 'f': 'ÃÂ¡ÃÂ¶?,
    'g': 'ÃÂ¡ÃÂµ?, 'h': 'ÃÃÂ°', 'i': 'ÃÂ¢?, 'j': 'ÃÃÂ²', 'k': 'ÃÂ¡ÃÂµ?, 'l': 'ÃÃÂ¡',
    'm': 'ÃÂ¡ÃÂµ?, 'n': 'ÃÂ¢?, 'o': 'ÃÂ¡ÃÂµ?, 'p': 'ÃÂ¡ÃÂµ?, 'r': 'ÃÃÂ³', 's': 'ÃÃÂ¢',
    't': 'ÃÂ¡ÃÂµ?, 'u': 'ÃÂ¡ÃÂµ?, 'v': 'ÃÂ¡ÃÂµ?, 'w': 'ÃÃÂ·', 'x': 'ÃÃÂ£', 'y': 'ÃÃÂ¸', 'z': 'ÃÂ¡ÃÂ¶?,
}

SMALLCAPS_MAP = {
    'a': 'ÃÂ¡ÃÂ´', 'b': 'Ã', 'c': 'ÃÂ¡ÃÂ´?, 'd': 'ÃÂ¡ÃÂ´?, 'e': 'ÃÂ¡ÃÂ´?, 'f': 'ÃÂª?,
    'g': 'ÃÃÂ¢', 'h': 'Ã', 'i': 'ÃÃÂª', 'j': 'ÃÂ¡ÃÂ´?, 'k': 'ÃÂ¡ÃÂ´?, 'l': 'Ã',
    'm': 'ÃÂ¡ÃÂ´?, 'n': 'ÃÃÂ´', 'o': 'ÃÂ¡ÃÂ´?, 'p': 'ÃÂ¡ÃÂ´?, 'q': 'ÃÃÂ«', 'r': 'Ã',
    's': 'ÃÂª?, 't': 'ÃÂ¡ÃÂ´?, 'u': 'ÃÂ¡ÃÂ´?, 'v': 'ÃÂ¡ÃÂ´?, 'w': 'ÃÂ¡ÃÂ´?, 'y': 'Ã', 'z': 'ÃÂ¡ÃÂ´?,
}
...
BRAILLE_MAP = {
    'a': 'ÃÂ¢ÃÂ ?, 'b': 'ÃÂ¢ÃÂ ?, 'c': 'ÃÂ¢ÃÂ ?, 'd': 'ÃÂ¢ÃÂ ?, 'e': 'ÃÂ¢ÃÂ ?,
    'f': 'ÃÂ¢ÃÂ ?, 'g': 'ÃÂ¢ÃÂ ?, 'h': 'ÃÂ¢ÃÂ ?, 'i': 'ÃÂ¢ÃÂ ?, 'j': 'ÃÂ¢ÃÂ ?,
    'k': 'ÃÂ¢ÃÂ ?, 'l': 'ÃÂ¢ÃÂ ?, 'm': 'ÃÂ¢ÃÂ ?, 'n': 'ÃÂ¢ÃÂ ?, 'o': 'ÃÂ¢ÃÂ ?,
    'p': 'ÃÂ¢ÃÂ ?, 'q': 'ÃÂ¢ÃÂ ?, 'r': 'ÃÂ¢ÃÂ ?, 's': 'ÃÂ¢ÃÂ ?, 't': 'ÃÂ¢ÃÂ ?,
    'u': 'ÃÂ¢ÃÂ ?, 'v': 'ÃÂ¢ÃÂ ?, 'w': 'ÃÂ¢ÃÂ ?, 'x': 'ÃÂ¢ÃÂ ?, 'y': 'ÃÂ¢ÃÂ ?,
    'z': 'ÃÂ¢ÃÂ ?, ' ': 'ÃÂ¢ÃÂ ',
}
...
def _apply_raw(word):
    """Raw ÃÂ¢?no transformation (baseline)."""
    return word

def _apply_leetspeak(word):
    """L33t ÃÂ¢?basic leetspeak substitution."""
    return ''.join(LEET_MAP.get(c.lower(), c) for c in word)

def _apply_unicode(word):
    """Unicode ÃÂ¢?Cyrillic/homoglyph substitution."""
    result = []
    for c in word:
...
def _apply_bubble(word):
    """Bubble ÃÂ¢?circled letter Unicode characters."""
    result = []
    for c in word:
        code = ord(c.lower())
        if 97 <= code <= 122:
...
def _apply_spaced(word):
    """Spaced ÃÂ¢?insert spaces between characters."""
    return ' '.join(word)

def _apply_fullwidth(word):
    """Fullwidth ÃÂ¢?fullwidth Unicode characters."""
    result = []
    for c in word:
        code = ord(c)
        if 33 <= code <= 126:
...
def _apply_brackets(word):
    """[B.r.a.c.k] ÃÂ¢?each character in brackets."""
    return '[' + ']['.join(word) + ']'

def _apply_mathbold(word):
    """MathBold ÃÂ¢?mathematical bold Unicode."""
    result = []
    for c in word:
        code = ord(c.lower())
        if 97 <= code <= 122:
...
def _apply_mathitalic(word):
    """MathItalic ÃÂ¢?mathematical italic Unicode."""
    result = []
    for c in word:
        code = ord(c.lower())
        if 97 <= code <= 122:
...
def _apply_strikethrough(word):
    """SÃÃÂ¶tÃÃÂ¶rÃÃÂ¶iÃÃÂ¶kÃÃÂ¶eÃÃÂ¶ ÃÂ¢?strikethrough combining characters."""
    return ''.join(c + '\u0336' for c in word)

def _apply_leetheavy(word):
    """L33t+ ÃÂ¢?heavy leetspeak with extended map."""
    return ''.join(LEET_MAP_HEAVY.get(c.lower(), LEET_MAP.get(c.lower(), c)) for c in word)

def _apply_hyphenated(word):
    """Hyphen ÃÂ¢?hyphens between characters."""
    return '-'.join(word)

# --- TIER 3: MULTI-LAYER COMBOS (23ÃÂ¢?3) -------------------------

def _apply_leetunicode(word):
    """L33t+Uni ÃÂ¢?alternating leet and unicode."""
    result = []
...
def _apply_spacedmixed(word):
    """S p A c E d ÃÂ¢?spaced + alternating case."""
    return ' '.join(c.upper() if i % 2 else c.lower() for i, c in enumerate(word))

def _apply_reversedleet(word):
    """Rev+L33t ÃÂ¢?reversed then leetspeak."""
    return ''.join(LEET_MAP.get(c.lower(), c) for c in reversed(word))

def _apply_bubblespaced(word):
    """Bubble+Spaced ÃÂ¢?bubble text with spaces."""
    result = []
    for c in word:
        code = ord(c.lower())
        if 97 <= code <= 122:
...
def _apply_unicodezwj(word):
    """Uni+ZWJ ÃÂ¢?unicode homoglyphs with zero-width non-joiners."""
    result = []
    for c in word:
        mapped = UNICODE_MAP.get(c.lower())
...
def _apply_base64hint(word):
    """Base64 ÃÂ¢?base64 encode the word."""
    try:
...
def _apply_hexencode(word):
    """Hex ÃÂ¢?hex encode each character."""
    return ' '.join(f'0x{ord(c):x}' for c in word)

def _apply_acrostic(word):
    """Acrostic ÃÂ¢?NATO alphabet expansion."""
    result = []
    for c in word:
        idx = ord(c.lower()) - 97
        if 0 <= idx < 26:
...
def _apply_dottedunicode(word):
    """Dot+Uni ÃÂ¢?unicode homoglyphs with dots."""
    result = []
    for c in word:
        mapped = UNICODE_MAP.get(c.lower())
        result.append(mapped if mapped else c)
...
def _apply_fullwidthmixed(word):
    """FW MiX ÃÂ¢?fullwidth + mixed case alternating."""
    result = []
    for i, c in enumerate(word):
        code = ord(c)
...
def _apply_triplelayer(word):
    """Triple ÃÂ¢?leet + unicode + uppercase rotating with ZWJ."""
    result = []
    for i, c in enumerate(word):
        lower = c.lower()
        mod = i % 3
...
def to_bubble(text):
    ...
    circled = 'ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ ÃÂ¢ÃÂ¡ÃÂ¢ÃÂ¢ÃÂ¢ÃÂ£ÃÂ¢ÃÂ¤ÃÂ¢ÃÂ¥ÃÂ¢ÃÂ¦ÃÂ¢ÃÂ§ÃÂ¢ÃÂ¨ÃÂ¢ÃÂ©'
    result = []
    for c in text:
        idx = ord(c.lower()) - 97
        if 0 <= idx < 26:
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Parseltongue ÃÂ¢?Input Obfuscation Engine')
